/**
 * Download face-api model weights to server/models and public/models
 */
...
await ensureModels(path.join(root, 'server', 'models'));
await ensureModels(path.join(root, 'public', 'models'));
console.log('Done. Face detection models ready for pipeline + client gate.');
